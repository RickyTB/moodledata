...
$string['seb_allowreloadinexam_help'] = 'Si se habilita, la re-carga de página es permitida (botón re-cargar en la barra de trabajo del SEB, menú deslizador lateral de iOS, atajo de teclado F5/cmd+R). Tenga en cuenta que puede romperse el cacheo fuera de línea cuando el usuario intenta re-cargar una página sin una conexión a internet.';
...
$string['seb_requiresafeexambrowser_help'] = 'Si se habilita, los estudiantes solamente pueden intentar el examen usando el navegador de Safe Exam Browser (Navegador de Examen Seguro).
Las opciones disponibles son:

* No
<br/>Safe Exam Browser no es requerido para intentar el examen.
* Si – Usar una plantilla existente
<br/>Puede ser usada una plantilla para la configuración de Safe Exam Browser. Las plantillas son gestionadas por el Administrador de Moodle. Sus configuraciones manuales de Usted anularán las configuraciones en la planilla.
...
* Si – Usar configuración del cliente de Safe Exam Browser
...
$string['seb_showsebtaskbar_help'] = 'Si se habilita, una barra de trabajo aparece al fondo de la ventana del navegador de SEB. La barra de trabajo es necesaria para mostrar elementos tales como control de Wi-Fi, botón para re-cargar y disposición del teclado y la hora.';
...
$string['seb_showwificontrol_help'] = 'Si se habilita, aparece un botón para control de Wi-Fi en la barra de trabajo de SEB. El botón le permite a los usuarios el re-conectarse a redes wi-Fi a las que previamente hayan estado conectados.';
