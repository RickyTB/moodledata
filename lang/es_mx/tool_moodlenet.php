...
/**
 * Strings for component 'tool_moodlenet', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
...
$string['aria:enterprofile'] = 'Ingrese su URL de perfil de MoodleNet';
...
$string['forminfo'] = 'Su perfil de MoodleNet será guardado automáticamente en su perfil en este sitio.';
...
$string['importformatselectguidingtext'] = '¿En cual formato le gustaría que este contenido "{$a->name} ({$a->type})" sea añadido a su curso?';
$string['importformatselectheader'] = 'Elegir el formato de visualización del contenido';
$string['inputhelp'] = 'Si Usted ya tiene una cuenta de MoodleNet, ingrese su perfil de MoodleNet:';
...
$string['profilevalidationerror'] = 'Hubo un problema al intentar validar su perfil';
$string['profilevalidationfail'] = 'Por favor ingrese un perfil MoodleNet válido';
