...
/**
 * Strings for component 'jitsi', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
 * @package   jitsi
...
$string['blurbutton'] = 'Opción para difuminar';
$string['blurbuttonex'] = 'Mostrar opción para difuminar';
...
$string['infoicon'] = 'Ícono de Información';
$string['infoiconex'] = 'Mostrar ícono de información en sesión';
...
$string['streamingbutton'] = 'Transmisión YouTube streaming';
$string['streamingbuttonex'] = 'Mostrar opción de streaming (solo para moderadores)';
...
$string['watermarklinkex'] = 'qtype_stack';
